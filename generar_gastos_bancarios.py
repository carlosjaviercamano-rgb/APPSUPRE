...
_PALABRAS_CLAVE = [
    (("IVA",),                                                "IVA"),
    (("SERVICIO", "COMISION", "COMISIÓN", "COMIS", "ND COBRO DISP", "COBRO TRANSFERENCIA", "CARGO POR TRANSACCIONES VARIAS", "COBRO TRANSF. ENVIADA OTRA ENTIDAD", "ND COBRO RECAUD DAVIPLATA", "7080-3202-CONTIGO EN TU NEGOCIO"), "COMISION"),
