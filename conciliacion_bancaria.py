...
EMPRESAS_CUENTAS = {
    ...
    "AmanecerDePascua":     [("AMANECER DE PASCUA OCCIDENTE CTA CTE 5004",  111005002)],
    "AnochecerDePascua":    [("ANOCHECER DE PASCUA OCCIDENTE CTA CTE 4999", 111005002)],
    "MañanaDePascua":       [("MAÑANA DE PASCUA OCCIDENTE CTA CTE 7481",    111005002),
                             ("BANCOLOMBIA CTA CTE 7472",         111005001)],
    "GriGroup":             [("GRI OCCIDENTE CTA CTE 1525",         111005002)],
    "Movicap":              [("MOVICAPSAS OCCIDENTE CTE 4395",       111005002),
                             ("AHO MOVICAP OCCIDENTE 2050",         112005002)],
    "ConfianzaGlobal":      [("OCCIDENTE AHORRO CTA No 9890",      112005001)],
    "SeguroConfianzaGlobal":[("AHO SEGUROS CONFIANZA OCCIDENTE 2449",        112005002)],
